...
//        setContentView(R.layout.activity_main);
        ...
        allCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this, com.rajendra.onlinedailygroceries.AllCategory.class);
                startActivity(i);
            }
        });
        ...
        categoryList.add(new Category(1, health));
        categoryList.add(new Category(2, bestcrop));
        categoryList.add(new Category(3, predict));
        categoryList.add(new Category(4, health));
        categoryList.add(new Category(5, bestcrop));
        categoryList.add(new Category(6, predict));
        categoryList.add(new Category(7, health));
        categoryList.add(new Category(8, bestcrop));
